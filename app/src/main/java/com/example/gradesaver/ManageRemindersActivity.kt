...
class ManageRemindersActivity : AppCompatActivity() {
    ...
    private fun showDatePicker(reminderMessage: String) {
        ...
        DatePickerDialog(this, R.style.PurpleDatePickerDialog, { _, year: Int, month: Int, dayOfMonth: Int ->
    ...
    private fun showTimePicker(calendar: Calendar, reminderMessage: String) {
        TimePickerDialog(this, R.style.PurpleTimePickerDialog, { _, hourOfDay: Int, minute: Int ->
    ...
    private fun addReminder(reminderMessage: String, reminderDateTime: Date) {
        currentScheduleId?.let { scheduleId ->
            lifecycleScope.launch {
                ...
                val reminderId = db.appDao().insertReminder(newReminder).toInt()
                scheduleNotification(reminderId, reminderMessage, reminderDateTime)
    ...
    private fun scheduleNotification(reminderId: Int, message: String, reminderDate: Date) {
        val activity = intent.getSerializableExtra("ACTIVITY") as? Activity ?: return
        val userId = getUserIdFromPreferences()
        val notificationIntent = Intent(this, NotificationReceiver::class.java).apply {
            putExtra("reminderId", reminderId)
            putExtra("activityName", activity.activityName)
